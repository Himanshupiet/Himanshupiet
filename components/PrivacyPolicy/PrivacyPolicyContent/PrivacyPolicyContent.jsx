...
import PrivacyPolicyStyle from './PrivacyPolicyContent.module.css'

const PrivacyPolicyContent = (props) => {
  return(
    <>
      <Container fluid className={PrivacyPolicyStyle.top_banner}>
        <Row>
          <Col lg={1}></Col>
          <Col lg={10}>
      ...
      <Container fluid >
        <Row>
          <Col lg={1}></Col>
          <Col lg={10}>
            <div className={PrivacyPolicyStyle.content_outer}>
              <h2>MARRA FORNI PRIVACY POLICY</h2>
              <p>[Marra Forni] (the “Company”) is committed to maintaining robust privacy protections for its users.  Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use and safeguard the information you provide to us and to assist you in making informed decisions when using our Service.</p>
              <p>For purposes of this Agreement, “Site” refers to the Company’s website, which can be accessed at [www.marraforni.com] [or through our mobile application].</p>
              <p>“Products” refers to the Company’s products accessed via the Site, in which users can find all relevant information on Marra Forni ovens, accessories and value-added services].</p>
              <p>The terms “we,” “us,” and “our” refer to the Company.</p>
              <p>“You” refers to you, as a user of our Site or our Service.</p>
              <p>By accessing our Site or our Service, you accept our Privacy Policy and Terms of Sale (found here: [<Link href='/terms-and-conditions'><a title='Terms of Sale'>Terms of Sale</a></Link>]), and you consent to our collection, storage, use and disclosure of your Personal Information as described in this Privacy Policy.</p>

              <h3>1. INFORMATION WE COLLECT</h3>
              <p>We collect “Non-Personal Information” and “Personal Information.” Non-Personal Information includes information that cannot be used to personally identify you, such as anonymous usage data, general demographic information we may collect, referring/exit pages and URLs, platform types, preferences you submit and preferences that are generated based on the data you submit and a number of clicks. Personal Information includes your name, address, email, contact information, etc.], which you submit to us through the registration process at the Site.</p>

              <h4>1.1 Information collected via Technology</h4>
              <p>To activate the Service you do not need to submit any Personal Information other than your email address. To use the Service thereafter, you do not] need to submit further Personal Information [, which may include: list date of birth, payment details, social, etc]. However, in an effort to improve the quality of the Service, we track information provided to us by your browser or by our software application when you view or use the Service, such as the website you came from (known as the “referring URL”), the type of browser you use, the device from which you connected to the Service, the time and date of access, and other information that does not personally identify you. We track this information using cookies, or small text files which include an anonymous unique identifier. Cookies are sent to a user’s browser from our servers and are stored on the user’s computer hard drive. Sending a cookie to a user’s browser enables us to collect Non-Personal information about that user and keep a record of the user’s preferences when utilizing our services, both on an individual and aggregate basis. For example, the Company may use cookies to collect the following information:</p>
              <small>[referring domain, session time, website activity or events]</small>
              <p>The Company may use both persistent and session cookies; persistent cookies remain on your computer after you close your session and until you delete them, while session cookies expire when you close your browser.  [For example, we store a persistent cookie to track idle session timeout.</p>

              <h4>1.2 Information you provide us by registering for newsletter updates</h4>
              <p>In addition to the information provided automatically by your browser when you visit the Site, to become a subscriber to the Service you will need to register for our newsletter. You can register for newsletters by entering your email address, and name and a complete phone. By registering, you are authorizing us to collect, store and use your email address in accordance with this Privacy Policy.</p>

              <h4>1.3 Children’s Privacy</h4>
              <p>The Site and the Service are not directed to anyone under the age of 13. The Site does not knowingly collect or solicit information from anyone under the age of 13, or allow anyone under the age of 13 to sign up for the Service. In the event that we learn that we have gathered personal information from anyone under the age of 13 without the consent of a parent or guardian, we will delete that information immediately. If you believe we have collected such information, please contact us at [marketing@marraforni.com].</p>

              <h3>2. HOW WE USE AND SHARE INFORMATION</h3>
              ...
              <p>We implement security measures designed to protect your information from unauthorized access. Your personal information is only accessible to authorized people within our organization. We further protect your information from potential security breaches by implementing certain technological security measures including encryption, firewalls, and secure socket layer technology. However, these measures do not guarantee that your information will not be accessed, disclosed, altered, or destroyed by breach of such firewalls and secure server software. By using our Service, you acknowledge that you understand and agree to assume these risks.</p>

              <h3>4. YOUR RIGHTS REGARDING THE USE OF YOUR PERSONAL INFORMATION</h3>
              <p>You have the right at any time to prevent us from contacting you for marketing purposes.  When we send promotional communication to a user, the user can opt-out of further promotional communications by following the unsubscribe instructions provided in each promotional email. You can also indicate that you do not wish to receive marketing communications from us in the [newsletter communications] you receive. Please note that notwithstanding the promotional preferences you indicate by either unsubscribing or opting out of all promotional communications, we may continue to send you administrative emails including, for example, periodic updates to our Privacy Policy.</p>
              ...
              <h3>7. CONTACT US</h3>
              <p>If you have any questions regarding this Privacy Policy or the practices of this Site, please contact us by sending an email to [<Link href='mailto:marketing@marraforni.com'><a title='marketing@marraforni.com'>marketing@marraforni.com</a></Link>].</p>
              <p>Last Updated: This Privacy Policy was last updated on [08/18/20].</p>
            </div>
          </Col>
          <Col lg={1}></Col>
        </Row>
