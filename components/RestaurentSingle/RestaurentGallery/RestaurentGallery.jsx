        ...
        <>
            <Container fluid className={RestaurentStyle.top_banner}
                ...
                <Row>
                    <Col lg={1}></Col>
                    <Col lg={10}>
                        <div className={RestaurentStyle.overlay}>
                            <h1 className='text-white'>{title}</h1>
                            <p className='text-white'>Pi Co offers quality, made-to-order, Neapolitan-style pizzas in a
                                unique quick-serve
                                experience. Visit Pi Co for more tasty pizzas, salads, gluten-free ‘za and meals</p>
