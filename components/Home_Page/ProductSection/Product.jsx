            ...
            <ScrollAnimation duration={1} animateIn="fadeInLeft" animateOnce={true}>
              <div className={ProductStyle.product_inner}>
                ...
                <div className={ProductStyle.product_info}>
                  <h4>Rotator</h4>
                  <p>{("High-performance, high-efficiency, user-friendly for unskilled labor").substr(0,80)}{("High-performance, high-efficiency, user-friendly for unskilled labor").length > 80 && "..."}</p>
          ...
          <Col lg={3} md={6}>
            <ScrollAnimation duration={1} animateIn="fadeInUp" animateOnce={true}>
              <div className={ProductStyle.product_inner}>
                ...
                <div className={ProductStyle.product_info}>
                  <h4>Neapolitan</h4>
                  <p>{("The “Classic” brick oven solution for static and mobile applications. Available in Wood, Gas, and Combination").substr(0,80)}{("The “Classic” brick oven solution for static and mobile applications. Available in Wood, Gas, and Combination").length > 80 && "..."}</p>
          ...
          <Col lg={3} md={6}>
            <ScrollAnimation duration={1} animateIn="fadeInUp" animateOnce={true}>
              <div className={ProductStyle.product_inner}>
                ...
                <div className={ProductStyle.product_info}>
                  <h4>Electric</h4>
                  <p>{("The look of a Traditional wood or gas-fired oven with Top and bottom heat controls").substr(0,80)}{("The look of a Traditional wood or gas-fired oven with Top and bottom heat controls").length > 80 && "..."}</p>
                  <Link href="/electric">
          ...
          <Col lg={3} md={6}>
            <ScrollAnimation duration={1} animateIn="fadeInRight" animateOnce={true}>
              <div className={ProductStyle.product_inner}>
                ...
                <div className={ProductStyle.product_info}>
                  <h4>Due Bocche</h4>
                  <p>{("All of the benefits of the Classic Neapolitan or the Rotator in a Pass-Thru configuration").substr(0,80)}{("All of the benefits of the Classic Neapolitan or the Rotator in a Pass-Thru configuration").length > 80 && "..."}</p>
