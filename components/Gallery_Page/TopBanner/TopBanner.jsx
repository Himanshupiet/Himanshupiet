...
const TopBanner = (props) => {
  ...
  useEffect(()=>{
    ...
    _convertToUnit = function _convertToUnit(target, property, value, unit) {
      ...
      if (_transformProps[property] && property !== "transform") {
        ...
        if (!value || value === "auto" || uncache || ~(value + "").indexOf("calc(")) {
          value = _specialProps[property] && _specialProps[property](target, property, unit) || _getComputedProperty(target, property) || (0, _gsapCore._getProperty)(target, property) || (property === "opacity" ? 1 : 0); 
        }
      }
      ...
      a = [start, end];
      (0, _gsapCore._colorStringFilter)(a);
          ...
          if (specialProp) {
            ...
            if (isTransformRelated) {
              if (!transformPropTween) {
                ...
                transformPropTween = this._pt = new _gsapCore.PropTween(this._pt, style, _transformProp, 0, 1, cache.renderTransform, cache, 0, -1);
    ...
    (0, _utils.preloadImages)('.grid__item-img, .bigimg').then(function () {
      ...
      var grid = new _grid.default(document.querySelector('.gallery_grid'));
    });
  ...
  return(
    <>
      <div className="banner_outer">
        <div className="content">
          <div className="gallery_grid">
            <div className="grid__item pos-1"><div className="grid__item-img" style={{backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH}/images/Gallery_Banner/banner_1.jpg)`}}></div></div>
            <div className="grid__item pos-2"><div className="grid__item-img" style={{backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH}/images/Gallery_Banner/banner_2.jpeg)`}}></div></div>
            <div className="grid__item pos-3"><div className="grid__item-img" style={{backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH}/images/Gallery_Banner/banner_3.jpg)`}}></div></div>
            <div className="grid__item pos-4"><div className="grid__item-img" style={{backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH}/images/Gallery_Banner/banner_4.jpg)`}}></div></div>
            <div className="grid__item pos-5"><div className="grid__item-img" style={{backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH}/images/Gallery_Banner/banner_5.jpg)`}}></div></div>
            <div className="grid__item pos-6"><div className="grid__item-img" style={{backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH}/images/Gallery_Banner/banner_6.jpg)`}}></div></div>
            <div className="grid__item pos-7"><div className="grid__item-img" style={{backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH}/images/Gallery_Banner/banner_7.jpg)`}}></div></div>
            <div className="grid__item pos-8"><div className="grid__item-img" style={{backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH}/images/Gallery_Banner/banner_8.jpg)`}}></div></div>
            <div className="grid__item pos-9"><div className="grid__item-img" style={{backgroundImage:`url(${process.env.NEXT_PUBLIC_BASE_PATH}/images/Gallery_Banner/banner_9.jpg)`}}></div></div>
      ...
      <svg className="cursor" width="0" height="0" viewBox="0 0 0 0">
        <circle className="cursor__inner" cx="0" cy="0" r="0"></circle>
      </svg>
    </>
   )
  }
