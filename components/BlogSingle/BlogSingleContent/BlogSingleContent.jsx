  ...
  return(
    <>
      <div className={BlogSingleContentStyle.feature_image}>
        <img alt='5 Ways MarraStone Revolutionizes The Brick Oven' src={'https://blog.marraforni.com/wp/wp-content/uploads/2021/05/MicrosoftTeams-image.png'} width='1000' height='800' className='img-fluid' />
      </div>
      <div className={BlogSingleContentStyle.title_box}>
        ...
        <div className={BlogSingleContentStyle.meta_info}>
          <span>April 30, 2021</span> <span>|</span> <span>By Marra Forni Marketing</span>
        </div>
      </div>
      <div className={BlogSingleContentStyle.content_box}>
        <p>Food enthusiasts have been fired up about brick ovens since the beginning of written history. Did you know that sundried bricks are the first known manufactured material? Everything from ancient Egyptian tomb depictions to relics from excavations at Pompei confirm the longstanding popularity of brick oven cooking. Back in those days, brick ovens were used to cook everything, not just pizza.  The American Colonists even used sun-dried bricks to construct the first streets in the United States. Later, it was found that bricks that were baked in an oven were stronger and more resilient to the weather.</p>
        <p>The type of bricks that are used in oven construction is an integral detail to consider for both design and functionality. At Marra Forni, we are always looking to improve upon existing techniques and innovate, “if there is a way to enhance traditional ovens, I will implement it,” says our COO and Co-Founder Enzo Marra.  When constructing our ovens, Enzo wanted to ensure that the bricks he chose would produce not only the best pizza but also the best versions of other types of foods as well.</p>
