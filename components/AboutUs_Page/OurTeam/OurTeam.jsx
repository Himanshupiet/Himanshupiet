          ...
          <Row>
            <Col xl={3} lg={4} sm={6}>
              <div className={OurTeamStyle.team_outer}>
                <img className='img-fluid' src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/AboutUs_Timeline/PIC_7775.jpg`} alt='Our Team' width='1500' height='1500' />
                <div className={OurTeamStyle.team_overlay}>
                  <h4>FRANCESCO MARRA</h4>
                  <p>CEO & CO-FOUNDER</p>
          ...
          <Row>
            <Col md={6}>
              <div className={OurTeamStyle.team_banner_outer}>
                <img className='img-fluid' src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/AboutUs_Timeline/PIC_7716.jpg`} alt='Our Team' width='1500' height='1000' />
                <h4>METAL FABRICATION TEAM</h4>
              </div>
            </Col>
            <Col md={6}>
              <div className={OurTeamStyle.team_banner_outer}>
                <img className='img-fluid' src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/AboutUs_Timeline/PIC_7747.jpg`} alt='Our Team' width='1500' height='1000' />
