...
const Footer = (props) => {
    ...
    return (
        <>
                            ...
                            <Row>
                                <Col lg={3} md={6} className={footerStyle.footer_inner}>
                                    ...
                                    <div>
                                        ...
                                        Ph. <Link href="tel:8882390575"><a
                                        title="888.239.0575">888.239.0575</a></Link><br/>
                                        Fax. 240.667.7991<br/><br/>
                                        <Link href="mailto:inquiries@marraforni.com"><a
                                            title="inquiries@marraforni.com">inquiries@marraforni.com</a></Link>
                                    </div>
                                    <img alt="Marra Forni Logo"
                                         src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/LogoRed.png`} width="226"
                                ...
                                <Col lg={3} md={6} className={footerStyle.footer_inner}>
                                    ...
                                    <ul>
                                        <li>
                                            <Link href="/resources">
                                                <a title="Spec Sheets, CAD Blocks, Manuals">Spec Sheets, CAD Blocks,
                                                    Manuals</a>
                                            </Link>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <Link href="https://www.pizzauniversity.org/">
                                                <a target="_blank" rel="noreferrer" title="Pizza University">Pizza
                                                    University</a>
                                            </Link>
                                        </li>
                                        <li>
                                ...
                                <Col lg={3} md={6} className={footerStyle.footer_inner}>
                                    ...
                                    <div className={footerStyle.social_outer}>
                                        ...
                                        <Link href="https://www.instagram.com/marraforni">
                                            <a target="_blank" rel="noopener" title="Instagram"><span><FontAwesomeIcon
                                                icon={faInstagram}/></span></a>
                                        </Link>
                                        ...
                                        <Link href="https://www.youtube.com/user/marraforni">
                                            <a target="_blank" rel="noopener" title="Our Videos"><span><FontAwesomeIcon
                                                icon={faYoutube}/></span></a>
                                        </Link>
                                    </div>
                                    <Link href="/register">
                                        <a className="mf_btn" title="register">Rep portal</a>
                                    </Link>
                                </Col>
                            </Row>
                        </Col>
            ...
            <div className={`${footerStyle.back_to_top} ${backtotopshow ? footerStyle.back_to_top_active : ""}`}
                 onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})}><i className='bx bxs-chevron-up'></i>
            </div>
        </>
    )
}
